...
LANG_ID2SYMBOLS = {
    ...
    "jp": common_symbols + get_phoneme_set("lightning/downstream/phoneme_recognition/_phoneset/JSUT.txt"),
    "cz": [],
    "ko": common_symbols + get_phoneme_set("lightning/downstream/phoneme_recognition/_phoneset/kss.txt"),
    "nl": [],
}

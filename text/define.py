...
LANG_ID2SYMBOLS = {
    ...
    "jp": common_symbols + get_phoneme_set("lightning/downstream/phoneme_recognition/MFA/kss/phoneset.txt"),
    "cz": [],
    "ko": common_symbols + get_phoneme_set("lightning/downstream/phoneme_recognition/MFA/JSUT/phoneset.txt"),
    "nl": [],
}
